...
## Linters on changed lines (optional Docker sandbox)
...
Build the image once: `./scripts/docker/build_linter_sandbox.sh` in the [product repo](https://github.com/runningcodeio/ai-code-agent).
